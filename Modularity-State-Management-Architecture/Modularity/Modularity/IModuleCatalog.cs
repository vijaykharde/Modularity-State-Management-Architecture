...
namespace CsTech.Modularity
{
    ...
    public interface IModuleCatalog
    {
        ...
        ModuleInfo[] GetDependentModules(ModuleInfo moduleInfo);
        ...
        /// <returns>
        /// A array of <see cref="ModuleInfo"/> that contains both all <see cref="ModuleInfo"/>s in <paramref name="modules"/>
        /// and also all the <see cref="ModuleInfo"/> they depend on.
        /// </returns>
        ModuleInfo[] CompleteListWithDependencies(IEnumerable<ModuleInfo> modules);
