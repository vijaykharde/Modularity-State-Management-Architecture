...
namespace CsTech.Modularity.Configuration
{
    ...
    public class ModuleDependencyConfigurationElementCollection : ConfigurationElementCollection
    {
        /// <summary>
        /// Initializes a new instance of <see cref="ModuleDependencyConfigurationElementCollection"/>.
        /// </summary>
        public ModuleDependencyConfigurationElementCollection()
        {
        }
        ...
        public ModuleDependencyConfigurationElementCollection(ModuleDependencyConfigurationElement[] dependencies)
        {
