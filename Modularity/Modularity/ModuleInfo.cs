...
namespace CsTech.Modularity
{
    ...
    public class ModuleInfo : IModuleCatalogItem
    {
        ...
        /// <summary>
        /// Gets or sets the module's <see cref="ConfigurationElement"/>.
        /// </summary>
        /// <value>The <see cref="ConfigurationElement"/> of the module.</value>
        ...
        /// file://c:/MyProject/Modules/MyModule.dll for a loose DLL.
        /// </example>
        /// </summary>
